...
<head>
    ...
    <!-- Title  -->
    <title>ChatMeow - Landing page</title>
...
<div class="main">
            ...
            <div class="navbar-inner">
                ...
                <nav>
                    <ul class="navbar-nav" id="navbar-nav">
                        <li class="nav-item">
                            <a class="nav-link scroll" href="#home" style="color: #FFFFFF">Trang chủ</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link scroll" href="#features" style="color: #FFFFFF">Tính năng</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link scroll" href="#pricing" style="color: #FFFFFF">Bảng giá</a>
                        </li>
                        <li class="nav-item">
            ...
            <div class="row align-items-center h-100">
                ...
                <div class="col-12 col-md-7">
                    <div class="welcome-intro">
                        <h1>ChatMeow - Chat GPT 4 Plus</h1>
                        <p class="my-4">ChatMeow - tích hợp phiên bản Chat GPT 4 Plus mới nhất, với chi phí sử dụng chỉ 36,000, dễ dàng tiếp cận. Hỗ trợ giải quyết công việc, học tập ngay lập tức.</p>
                        <a href="#" class="btn" style="color: #FFFFFF">Đăng ký</a>
                    </div>
                </div>
            ...
            <div class="row justify-content-center">
                <div class="col-12 col-md-10 col-lg-8">
                    ...
                    <div class="section-heading text-center">
                        <h2>Khám phá những tính năng cao cấp</h2>
            ...
            <div class="row">
                <div class="col-12 col-md-6 col-lg-4">
                    ...
                    <div class="icon-box text-center p-4 wow fadeInUp" data-wow-duration="2s">
                        ...
                        <!-- Icon Text -->
                        <div class="icon-text">
                            <h3 class="mb-2">Chat GPT 4 Plus</h3>
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    ...
                    <div class="icon-box text-center p-4 wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.2s">
                        ...
                        <!-- Icon Text -->
                        <div class="icon-text">
                            <h3 class="mb-2">Rẻ hơn 15 lần</h3>
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Veritatis culpa expedita dignissimos.</p>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-md-6 col-lg-4">
                    ...
                    <div class="icon-box text-center p-4 wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.4s">
                        ...
                        <!-- Icon Text -->
                        <div class="icon-text">
                            <h3 class="mb-2">Nhanh hơn 100 lần</h3>
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Veritatis culpa expedita dignissimos.</p>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-md-6 col-lg-4">
                    ...
                    <div class="icon-box text-center p-4 wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.6s">
                        ...
                        <!-- Icon Text -->
                        <div class="icon-text">
                            <h3 class="mb-2">Luôn luôn ổn định</h3>
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Veritatis culpa expedita dignissimos.</p>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-md-6 col-lg-4">
                    ...
                    <div class="icon-box text-center p-4 wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.8s">
                        ...
                        <!-- Icon Text -->
                        <div class="icon-text">
                            <h3 class="mb-2">Độ chính xác cao</h3>
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Veritatis culpa expedita dignissimos.</p>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-md-6 col-lg-4">
                    ...
                    <div class="icon-box text-center p-4 wow fadeInUp" data-wow-duration="2s" data-wow-delay="1s">
                        ...
                        <!-- Icon Text -->
                        <div class="icon-text">
                            <h3 class="mb-2">Thanh toán MoMo</h3>
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Veritatis culpa expedita dignissimos.</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="row justify-content-between align-items-center">
                ...
                <div class="col-12 col-lg-6 order-1 order-lg-2">
                    ...
                    <div class="discover-text px-0 px-lg-4 pt-4 pt-lg-0">
                        <h2 class="pb-4">Giải quyết vấn đề nhanh hơn.</h2>
                        <!-- Check List -->
                        <ul class="check-list">
                            <li class="py-1">
                                <!-- List Box -->
            ...
            <div class="row justify-content-between">
                <div class="col-12 col-lg-6 order-2 order-lg-1">
                    ...
                    <div class="service-text pt-4 pt-lg-0">
                        <h2 class="mb-4">Chuyên gia trong các lĩnh vực</h2>
                        <!-- Service List -->
                        ...
                        <a href="#" class="btn btn-bordered mt-4" style="color: #ffffff">Đăng ký</a>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-12 col-md-10 col-lg-8">
                    <!-- Section Heading -->
                    <div class="section-heading text-center">
                        <h2 class="text-capitalize">Giao diện Vươn tới những vì sao</h2>
                        <p class="d-none d-sm-block mt-4">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Laborum obcaecati dignissimos quae quo ad iste ipsum officiis deleniti asperiores sit.</p>
                        <p class="d-block d-sm-none mt-4">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Laborum obcaecati.</p>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-12 col-md-10 col-lg-8">
                    <!-- Section Heading -->
                    <div class="section-heading text-center">
                        <h2>Mở khoá Tính năng tuyệt vời - Chi phí cực hời</h2>
                        <p class="d-none d-sm-block mt-4">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Laborum obcaecati dignissimos quae quo ad iste ipsum officiis deleniti asperiores sit.</p>
                        <p class="d-block d-sm-none mt-4">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Laborum obcaecati.</p>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-4">
                    <div class="single-price-plan text-center p-5 wow fadeInLeft" data-aos-duration="2s" data-wow-delay="0.4s">
                        ...
                        <div class="plan-title my-2 my-sm-3">
                            <h4 class="text-uppercase">Free 7-day trial</h4>
                        </div>
                        <!-- Plan Price -->
                        <div class="plan-price pb-2 pb-sm-3">
                            <h2 class="fw-7">Free<small class="fw-6"> trial</small></h2>
                        </div>
                        <!-- Plan Description -->
                        <div class="plan-description">
                            <ul class="plan-features">
                                <li class="border-top py-3">7 ngày dùng thử</li>
                                <li class="border-top py-3">Chat GPT bản thường</li>
                                <li class="border-top py-3">Phản hồi chậm</li>
                                <li class="border-top border-bottom py-3">Không ổn định</li>
                            </ul>
                        </div>
                        <!-- Plan Button -->
                        <div class="plan-button">
                            <a href="#" class="btn mt-4" style="color: #FFFFFF">Đăng Ký</a>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="accordion" id="sApp-accordion" >
                            <div class="row justify-content-center">
                                <div class="col-12 col-md-10 col-lg-8">
                                    ...
                                    <div class="card border-top-0 border-left-0 border-right-0 border-bottom" style="background-color: #001018; color: white;">
                                        <!-- Card Header -->
    ...
    <!--====== Footer Area Start ======-->
    <footer class="footer-area footer-fixed" style="background-color: #001018; color: white;">
        <!-- Footer Top -->
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 col-sm-6 col-lg-3">
                        ...
                        <div class="footer-items">
                            ...
                            <a class="navbar-brand" href="#">
                                <img class="logo" src="assets/img/logo/logo.png"  style="width: 52px; height: 52px" alt="">
                            </a>
                            ...
                            <div class="social-icons d-flex">
                                <a class="facebook" href="https://www.facebook.com/meowtechvn" target="_blank">
                                    <i class="fab fa-facebook-f"></i>
                                    <i class="fab fa-facebook-f"></i>
                                </a>
                                <a class="twitter" href="https://www.linkedin.com/company/meowtech/" target="_blank">
                                    <i class="fab fa-linkedin-in"></i>
                                    <i class="fab fa-linkedin-in"></i>
                                </a>
                                <a class="google-plus" href="https://g.page/r/CarwTJ5DitVnEAE" target="_blank">
                                    <i class="fab fa-google-plus-g"></i>
                                    <i class="fab fa-google-plus-g"></i>
                                </a>
                                <a class="instagram" href="https://www.instagram.com/meowtechvn" target="_blank">
                    ...
                    <div class="col-12 col-sm-6 col-lg-3">
                        ...
                        <div class="footer-items">
                            ...
                            <ul>
                                ...
                                <li class="py-2"><a href="https://meowtech.vn/about-us.php" target="_blank">About Us</a></li>
                                <li class="py-2"><a href="https://meowtech.vn/service.php" target="_blank">Services</a></li>
                                <li class="py-2"><a href="https://blog.meowtech.vn/" target="_blank">Blog</a></li>
                                <li class="py-2"><a href="https://meowtech.vn/contact.php" target="_blank">Contact</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-12 col-sm-6 col-lg-3">
                    ...
                    <div class="col-12 col-sm-6 col-lg-3">
                        ...
                        <div class="footer-items">
                            <!-- Footer Title -->
                            <h3 class="footer-title mb-2">Careers</h3>
                            <!-- Store Buttons -->
                            <div class="button-group store-buttons store-black d-flex flex-wrap">
                                <a href="https://meowtech.vn/careers.php" target="_blank">
                                    <img src="assets/img/icon/CHATMEOW-MEOWTECH-CAREERS.png" alt="">
                                </a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="copyright-area d-flex flex-wrap justify-content-center justify-content-sm-between text-center py-4">
                            <!-- Copyright Left -->
                            <div class="copyright-left">&copy; © 2023. All rights reserved</div>
                            <!-- Copyright Right -->
                            <div class="copyright-right"><a href="https://meowtech.vn/" target="_blank">MeowTech CO., LTD.</a></div>
                        </div>
                    </div>
                </div>
            </div>
